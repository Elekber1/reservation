$(document).ready(function () {
    ...
    var addEvent = function (start, end) {
      ...
      var renderEventOnCalendar = function() {
        ...
        title[3].checked ? roomNumber = '#1304 (Room on left)' : roomNumber = '#1305 (Room on right)'
        eventData = {
          title: studentName,
          occupants: occupants,
        ...
        title[3].checked ? eventData.color = '#2196f3' : eventData.color = '#4caf50'
      ...
      $('#myModal').modal('show');
      $('#submit').off('click').click(renderEventOnCalendar) || $('#studentname').keypress(function(event) {
